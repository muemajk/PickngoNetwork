...
setGlobalsForPeer0Org1() {
    ...
    # export CORE_PEER_MSPCONFIGPATH=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org1.pickngo.com/peers/peer0.org1.pickngo.com/msp
...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o localhost:7050 \
        --ordererTLSHostnameOverride orderer.pickngo.com --tls \
        --collections-config $PRIVATE_DATA_CONFIG \
...
# --peerAddresses peer0.org1.pickngo.com:7051 --tlsRootCertFiles $PEER0_ORG1_CA --peerAddresses peer0.org2.pickngo.com:9051 --tlsRootCertFiles $PEER0_ORG2_CA
...
approveForMyOrg2() {
    ...
    peer lifecycle chaincode approveformyorg -o localhost:7050 \
        --ordererTLSHostnameOverride orderer.pickngo.com --tls $CORE_PEER_TLS_ENABLED \
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.pickngo.com \
...
chaincodeInvokeInit() {
    ...
    peer chaincode invoke -o localhost:7050 \
        --ordererTLSHostnameOverride orderer.pickngo.com \
        --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA \
...
chaincodeInvoke() {
    # setGlobalsForPeer0Org1
    # peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pickngo.com \
