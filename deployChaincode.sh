...
presetup() {
    ...
    pushd ./artifacts/src/app/pickproducts/go
...
VERSION="1"
CC_SRC_PATH="./artifacts/src/app/pickproducts/go"
CC_NAME="pickngo"
...
chaincodeQuery() {
    setGlobalsForPeer0Org2
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryProduct","Args":["Product5"]}'
