...
var logger = log4js.getLogger('PicknGoNetwork');
...
app.options('*', cors());
app.use(cors());
app.use(session({secret:"fsdklvdfwerwerwefefveffsdfsdfdfr4tgtr",resave:false, saveUninitialized: true } ))
...
app.use(expressJWT({
	...
	path: ['/users', '/metrics', '/users/login']
}));
app.use(bearerToken());
